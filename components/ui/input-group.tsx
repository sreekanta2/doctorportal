...
>(({ className, color, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "border border-default-300 text-default-500 text-base font-normal  bg-background flex items-center justify-center px-3 first:border-r-0 last:border-l-0 first:rounded-l-md last:rounded-r-md group-focus-within:border-primary ring-primary  transition duration-300",
      className,
      {
