...
const MultiMenuHandler = ({
  ...
  return (
    <div
      ...
      className={cn(
        "text-base flex gap-3  rounded items-center transition-all duration-150 cursor-pointer  relative before:absolute  before: top-0 before:-left-5 before:w-[3px] before:h-0 before:transition-all before:duration-200",
        className,
        {
